...
namespace ShareMyThings.Models
{
    public class PhoneNumber : IFormattable
    {
        ...
        /// <summary>
        /// List of ServiceTypes enabled for this Phone Number.
        /// </summary>
        public List<PhoneNumberServcieType> EnabledServiceList { get; set; }
        ...
        public static bool TryParse(String source, out PhoneNumber result)
        {
            ...
            // Parse from X
            {
                try
                {
                    ...
                    {
                        InnerXml = String.Format("<?xml version=\"1.0\" encoding=\"utf-8\"?><root>{0}</root>", source)
                    };
